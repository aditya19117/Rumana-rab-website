...
export function PackagesHero() {
  return (
    <section className="relative isolate overflow-hidden bg-light-sage">
      ...
      <ImagePlaceholder
        alt="Packages & Pricing hero background"
      ...
      <div className="container-page relative z-10 flex min-h-[200px] items-center justify-center py-8 text-center sm:min-h-[260px] lg:min-h-[420px]">
        <div className="mx-auto max-w-2xl text-cream">
          ...
          <p className="mx-auto mt-2 max-w-xl font-display text-xl leading-tight text-white/85 sm:mt-3 sm:text-2xl lg:text-2xl">
            Choose the Right Package for Your Wellness Journey
          </p>
          <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed text-white/75 sm:text-base">
            Explore flexible yoga packages designed to support your practice, wellness, and everyday
            balance.
          </p>
